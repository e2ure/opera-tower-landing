    ...
    return (
        <div className="sectionAboutUs">
            ...
            <div className="contactInfo">
                <h2>Contactenos</h2>
                <a className="contactInfoItem" href="(+506) 7721-7734"><MdPhone className="item-logo" />(+506) 7721-7734</a>
                ...
                <a className="contactInfoItem" href="http://ws.me//(+506)88777777"><MdWhatsapp className="item-logo"/>(+506) 8877-7777</a>
                <a className="contactInfoItem" href="mailto:VENTAS@DESARROLLO.CR"> <MdMailOutline className="item-logo"/>ventas@desarrollo.cr</a>
            </div>
        </div>
    );
};
